...
```{r pip-1, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
library(prisma)
...
```{r pip-2, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
...
```{r pip-4, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
attributes(out[[1]])
```
...
```{r pip-6, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
snpSelection <- snpSummary[snpSummary$freq>1,]
...
```{r pip-7, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
snpSelection <- snpSummary[snpSummary$freq>1,]
...
```{r pip-13, eval=FALSE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE, collapse=TRUE}
...
```{r pip-14, eval=FALSE, echo=TRUE, tidy=FALSE, message=FALSE, warning=FALSE, collapse=TRUE}
