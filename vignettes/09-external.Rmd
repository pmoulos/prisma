...
```{r ext-5, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE, collapse=TRUE}
...
metrics <- applyPRS(snpSelection,gwe,response=response,covariates=covariates)
