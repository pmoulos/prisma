...
![The GWASExperiment class](gwasexperiment.png)
...
```{r gwe-1, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
...
```{r gwe-2, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
# Add SNPs (rbind)
...
```{r gwe-3, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
...
```{r gwe-4, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
...
```{r gwe-5, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
set.seed(42)
