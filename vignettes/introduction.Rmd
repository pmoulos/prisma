...
```{r intro-3, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE, collapse=TRUE}
# Workspace
d1 <- tempfile()
...
```{r intro-4, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
d2 <- tempfile()
...
```{r intro-5, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
d3 <- tempfile()
...
```{r intro-6, eval=TRUE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
...
```{r intro-7, eval=FALSE, echo=TRUE, tidy=FALSE, message=TRUE, warning=FALSE}
